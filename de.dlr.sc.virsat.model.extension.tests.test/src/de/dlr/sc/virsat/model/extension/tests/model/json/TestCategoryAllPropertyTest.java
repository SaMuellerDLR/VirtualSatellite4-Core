...
public class TestCategoryAllPropertyTest extends AConceptTestCase {
	...
	@Test
	public void testJsonMarshallingWithDefaultValues() throws JAXBException, IOException, NoSuchFieldException, SecurityException, ClassNotFoundException, IllegalArgumentException, IllegalAccessException {
	...
	public void unmarshalWithResource(String resource) throws JAXBException, IOException {
		Unmarshaller jsonUnmarshaller = JsonTestHelper.getUnmarshaller(jaxbUtility,
				Arrays.asList(tcAllProperty.getATypeInstance()));
